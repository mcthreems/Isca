...
bucket_depth = 0.01 - atm_bucket        # Bucket depth, in meters
isphum = atm_bucket*9.8/100.            # initial specific humidity (kg/kg)
es0 = 1                               # es0 as a factor of current Earth
omega_scale = 0.75                         # Scaling of rotation rate relative to Earth's (rotation in days)
...
namelist = Namelist({
    ...
    'hydrology_nml':{
        ...
        'infil_rate':5.0e-5, #Vertical hydraulic conductivity (m/s); setting the infil speeds to 0 to give effectively no infiltration
