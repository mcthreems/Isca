...
bucket_depth = 4.0                      # Bucket depth, in meters
...
namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'couple_flux_q':True, #trying to couple flux_q to sphum
        'evap_double':True #this is to test how adjusting the flux up to better match precip will affect things
    },
    ...
    'spectral_dynamics_nml': {
        ...
        'initial_sphum':[1.0e-6], #testing an initial sphum here to see if it affects the start
