...
namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'convection_scheme':'NONE', #Use the specified convection scheme (NONE,DRY,SIMPLE_BETTS_MILLER,FULL_BETTS_MILLER,RAS)
        'do_lscale_cond':True, #don't do lscale condensation
