...
lastyear = 40                           # Specify year to end on
...
es0 = 10                               # es0 as a factor of current Earth
...
diag.add_field('atmosphere', 'tam_albedo', time_avg=True)
...
namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'vis_albedo':0.4, #albedo default, applies to all cells if var_surf_prop is False, to dry cells if True
        'liq_albedo':0.3,
        'threshold_liq':1.0 #threshold for dry grid cells, in mm of depth
    },
