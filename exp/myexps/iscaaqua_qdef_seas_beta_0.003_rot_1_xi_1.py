...
RESOLUTION = 'T42', 25                  # T21 (orig T42) horizontal resolution, 25 (orig 25) levels in pressure
startrun = 19                           # Specify the starting run
...
albedo_land = 0.38                      # albedo over dry land
...
namelist = Namelist({
    ...
    'mixed_layer_nml': {
        ...
        'albedo_value': albedo_liquid                  #Albedo value used      
    },
