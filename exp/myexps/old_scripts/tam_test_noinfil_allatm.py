...
tsurf_init = 273.15                       # initial surface temperature (K)
...
diag.add_field('atmosphere', 'sphum2', time_avg=True)
diag.add_field('atmosphere', 'sphum3', time_avg=True)
diag.add_field('atmosphere', 'sphum4', time_avg=True)
diag.add_field('dynamics', 'sphum5', time_avg=True)
