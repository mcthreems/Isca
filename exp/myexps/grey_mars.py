...
namelist = Namelist({
    ...
    'sat_vapor_pres_nml': {
        'do_simple':True,
        'tcmin':  -260., #Make sure low temperature limit of saturation vapour pressure is low enough that it doesn't cause an error (note that this giant planet has no moisture anyway, so doesn't directly affect calculation.        
        'tcmax': 500.,
    },
