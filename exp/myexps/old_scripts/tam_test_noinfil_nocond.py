...
namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'convection_scheme':'FULL_BETTS_MILLER', #Use the specified convection scheme (NONE,DRY,SIMPLE_BETTS_MILLER,FULL_BETTS_MILLER,RAS)
        'do_lscale_cond':False, #don't do lscale condensation
    ...
    'tam_surface_flux_nml':{
        'sfc_heat_flx_amp':1.0    # want to see how this affects SH and LH (default = 1)
    },
