...
water_lat = 65.                          # latitude equator-ward of which is like land
atm_bucket = 0.0                        # initial depth of water in atmosphere (m)
bucket_depth = 1000 - atm_bucket        # Bucket depth, in meters
evap_thresh = bucket_depth              # threshold depth for evaporation within water_lat
...
namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'hydro_scheme':'BUCKET_HYDRO', #Run as mixed-layer aquaplanet
        'var_surf_prop':vsurfprop, #whether to adjust albedo based on water in grid cell
        'init_bucket_depth':bucket_depth
    },
    ...
    'mixed_layer_nml': {
        ...
        'evaporation':True,  
        'depth': 40,                          #Depth of mixed layer used
        'albedo_value': 0.38,                  #Albedo value used
        'land_lat':water_lat,
        'land_thresh':evap_thresh,
        'var_hcap':True,
        'land_h_capacity_prefactor':0.1 #factor for heat capacity over land      
    },
