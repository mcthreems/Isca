...
public :: mass_weighted_global_integral, mass_weighted_vertical_integral
...
!---------------------------------------------------------------------------------------------
function mass_weighted_vertical_integral(field, surf_press)

!  This function returns the mass weighted vertical integral of field.
!  The units of the result are:
!  (units of field)*(Kg/meters**2)
...
real, dimension(size(field,1), size(field,2)) :: vert_integral, mass_weighted_vertical_integral
...
do k=1,num_levels
  vert_integral = vert_integral + field(:,:,k)*dp(:,:,k)
enddo
mass_weighted_vertical_integral = vert_integral/grav

return
end function mass_weighted_vertical_integral
