...
bucket_depth = 5.e-2 - atm_bucket        # Bucket depth, in meters
...
namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'liq_albedo':0.3,
        'evap_thresh':0.0,  #threshold for evaporation (kg/m^2)
        'do_lscale_cond':True,
        'do_vert_diff':True,
        'do_direct_delta_tr':False
    },
    ...
    'tam_surface_nml':{
        ...
        'thermal_cond_reg':0.0,
        'thermal_cond_liq':0.0
    },
