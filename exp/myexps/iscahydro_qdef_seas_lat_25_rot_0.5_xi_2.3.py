...
albedo_land = 0.38                      # albedo over dry land (or everywhere if vsurfprop = False
albedo_liquid = 0.38                    # albedo over surface liquid
atm_bucket = 0.0                        # initial depth of water in atmosphere (m)
bucket_depth = 40 - atm_bucket        # Bucket depth, in meters
isphum = atm_bucket*9.8/100.            # initial specific humidity (kg/kg)
beta = 1.0                              # beta parameter from Fan et al
es0 = 2.3                               # es0 as a factor of current Earth
omega_scale = 0.5                         # Scaling of rotation rate relative to Earth's (rotation in days)
